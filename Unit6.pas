...
begin
 ...
 begin
 Form6_Mouse.panel_positivo.Caption:=' +'+IntToStr(Trunc(Valor_Mouse/1000));
 Form6_Mouse.panel_negativo.Caption:='0  ';
 end
 else
 begin
 Form6_Mouse.panel_positivo.Caption:='  0';
 Form6_Mouse.panel_negativo.Caption:=' ' +IntToStr(Trunc(Valor_Mouse/1000))+'  ';
 end;
 //------------------------------------------------------------------------
end;

procedure TForm6_Mouse.FormCreate(Sender: TObject);
var
Config_Fisico:TStringList;
i,Valor_Arquivo:Integer;
begin
Form6_Mouse.Caption:=Form1_DGL.Label_Sense.Caption;
//---------------------------------------------------------
...
procedure TForm6_Mouse.FormKeyPress(Sender: TObject; var Key: Char);
begin
 //--------------------------------------------
...
procedure TForm6_Mouse.MouseSensitivityChange(Sender: TObject);
begin
Label_PosiNega(MouseSensitivity.Position);
ActiveControl:=Nil;
end;
